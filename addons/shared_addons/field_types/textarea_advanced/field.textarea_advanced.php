 ...
 */
class Field_textarea_advanced
{
	public $field_type_slug			= 'textarea_advanced';
	public $field_type_name			= 'Textarea Advanced';
	...
	public $author					= array('name' => 'Loud+Clear', 'url' => 'http://loudclear.ca');
