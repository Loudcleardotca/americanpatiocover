(function($) {
	$(function() {
		...
		$item_list.find('li a').live('click', function(e) {
			...
			$details.html('<img src="'+BASE_URL + ADDONPATH + 'modules/images/img/ajax-loader.gif'+'" alt="Loading..." />');
			...
			$details.load(SITE_URL + 'admin/images/ajax_page_images/' + page_id, function(){
