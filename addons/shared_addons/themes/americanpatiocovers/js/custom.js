...
/*              8 - PORTFOLIO ISOTOPE JQUERY                */
/*----------------------------------------------------------*/
      var clearCurrentOption ="item-preview";
                ...
                if ($container.length) {
                    ...
                    $itemsFilter.on('click', 'a', function (e) {
                        ...
                        if (currentOption) {
							...
							if(currentOption !== '*'){
								clearCurrentOption = currentOption+"ciao";
							}else{
								clearCurrentOption = "item-preview";
							}
                            ...
                            $container.isotope({
                                filter: currentOption,
								 animationOptions: {             
					             complete: addClassForColorBox(clearCurrentOption)
					            }
...
/*              20 - COLORBOX                      			*/
/*----------------------------------------------------------*/
   function addClassForColorBox (clearCurrentOption){
		$("."+clearCurrentOption).colorbox({rel:clearCurrentOption});	
	}
...
/*----------------------------------------------------------*/
        if ($('#google-map').length && jQuery()) {
            ...
            $map.gMap({
                markers: [{
                    'address': 'Level 13, 14219 Smokey Point Blvd Marysville, WA 98271, USA',
                    icon: {
                        image: '/addons/shared_addons/themes/americanpatiocovers/img/marker-icon.png',
                        iconsize: [25, 41],
                    },
                }],
                zoom: 7,
